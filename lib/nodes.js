...
var funIni = function (ident, params, body, isGen, isExp, isLater, loc) {
    this.id = ident;
    this.params = params;
    this.body = body;
...
def('ArrowFunction', function(params, body, loc) {
    this.params = params;
    this.body = body;
    this.loc = loc;
});
...
def('YieldExpression', function (argument, star, loc) {
    this.argument = argument;
    this.star = star;
    this.loc = loc;
});
...
def('LaterStatement', function (argument, loc) {
    this.argument = argument;
    this.loc = loc;
});
...
def('DecoratedStatement', function (decorator, body, loc) {
...
def('YadaYadaStatement', function (loc) {
    this.loc = loc;
});
...
def('CurryExpression', function (callee, args, loc) {
    this.callee = callee;
    this["arguments"] = args;
    this.loc = loc;
});
